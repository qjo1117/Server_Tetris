...
int Board::SendPack(SocketInfo* p_info, int id, const string& name)
{
	...
	// 세부 정보를 패킹
	int size = Packing(&sendPtr, PROTOCOL::S_GAME_BOARD_INFO, id, _score.load(), (const char*)&name[0]);
